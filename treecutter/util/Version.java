...
public class Version
{
	...
	{
		CURRENT = Strings.nullToEmpty(TreeCutter.metadata.version);

		ModContainer mod = TreeCutterUtils.getModContainer();
		...
		if (TreeCutter.metadata.version.endsWith("dev"))
		{
			DEV_DEBUG = true;
		}
		else if (DEV_DEBUG)
		{
			TreeCutter.metadata.version += "-dev";
		}
	}

	public static CheckResult getResult()
	{
		return ForgeVersion.getResult(TreeCutterUtils.getModContainer());
	}
